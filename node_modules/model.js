...
/* ***************************** */
/* START BY ADDING A JIRA NUMBER */
/* ***************************** */

var jiraNumber = 12949;

/*********************************/

var config = JSON.parse(fs.readFileSync('assets/config/' + jiraNumber + '.json', 'utf8'));
...
Model.prototype = {
		...
		'inputFolderPath':        config.inputFolderPath,
		...
		'yearPublished':          config.year,
		'env':                    config.env,
		'shareMessage':           config.shareMessage,
		'shareUrl':               config.shareUrl,
		'shareImg':               config.shareImg,
		'moreReads':              config.moreReads,
		'chartbeatStoryName':     config.chartbeatStoryName,
		'setableOptionsArr':      [],
