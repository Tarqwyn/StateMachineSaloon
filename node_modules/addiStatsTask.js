...
function AddiStatsTask() {
	...
	function addCallToStoryJs() {
		...
		// var  istatCallStr = "(function () {'use strict';$(function () {var currentSectionNumber;	$('.section').each(function (i) {$(this).scrollWatch().on('scroll', function (e) {if (Math.abs(e.visibility) > .8) {if (currentSectionNumber !== i) {currentSectionNumber = i;if (istatsGlobal) {istatsGlobal.log('sectionView','shorthand.sectionView',{'time':Date.now(),'section': i});}}}})}) })})();";
