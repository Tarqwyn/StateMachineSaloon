...
function AddShareToolsTask() {
	...
	/*------------------------------------------------------------------
		Variables
	------------------------------------------------------------------*/
	var taskFlow = [checkRequireLoaderBootScriptExists, checkRequireLibExists, copyEventEmitterLib, copyBootstrap, copyModel, copyView, editBootScript, promptForMessage, updateIndexShareMessage, updateBootShareMessage, updateNSShareModelMessage];
	...
	function promptForMessage() {
		var promptMarkup = "<div class=\"userPromptHolder\">" +
								...
								"</p>" +
								"<input id='shareMessage' type='text' value='Six people who admitted links to two murders even though they couldn’t remember anything www.bbc.co.uk/news/magazine-27290883' style='display:block;'/>" +
								"<p>" +
									"<b>story page url:</b>" +
