...
function AddShareToolsTask() {
	...
	function updateIndexShareMessage() {
		...
		readModuleFile(model.outputFolderPath + '/index.html', function (err, indexHtmlStr) {
			...
			indexHtmlStr = indexHtmlStr.strReplace(shareImgHolder,     escape(model.shareImg));
	...
	function updateBootShareMessage() {
		...
		readModuleFile(bootScriptPath, function (err, bootScriptStr) {
			...
			bootScriptStr = bootScriptStr.strReplace(shareMessageHolder, escape(model.shareMessage));
			bootScriptStr = bootScriptStr.strReplace(shareUrlHolder,     escape(model.shareUrl));
			bootScriptStr = bootScriptStr.strReplace(shareImgHolder,     escape(model.shareImg));
	...
	function subTaskComplete() {
		currentSubTask ++;
		console.log('taskFlow: ' + taskFlow.length + ', currentSubTask: ' + taskFlow[currentSubTask]);
