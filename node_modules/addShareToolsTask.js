...
function AddShareToolsTask() {
	...
	function promptForMessage() {
		var promptMarkup = "<div class=\"userPromptHolder\">" +
								...
								"</p>" +
								"<input id='shareMessage' type='text' value='A good man in Rwanda: “This is the story of the bravest man I’ve ever met”' style='display:block;'/>" +
								"<p>" +
									"<b>story page url:</b>" +
								...
								"</p>" +
								"<input id='storyUrl' type='text' value='http://www.bbc.co.uk/news/magazine-26793157' style='display:block;'/>" +
