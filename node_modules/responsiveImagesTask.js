...
function ResponsiveImagesTask() {
	...
	function promptUser() {
		...
		var promptMarkup = "<div class=\"userPromptHolder\">" +
								...
								"</br>" +
									"<b>{picName}_{image size label}.jpg</b>" +
								"</br>" +
								"</br>" +
								...
								"</br>" +
								"chapter01Header_phonePortrait.jpg" +
								"</br>" +
								"chapter01Header_phoneLandscape.jpg" +
								"</br>" +
								"chapter01Header_tabletPortrait.jpg" +
								"</br>" +
								"chapter01Header_tabletLandscape.jpg" +
								"</br>" +
								"chapter01Header_largeDesktop.jpg" +
								"</br>" +
								"chapter01Header_extraLargeDesktop.jpg" +
								"</br>" +
								"</p>" +
							"</div>";
