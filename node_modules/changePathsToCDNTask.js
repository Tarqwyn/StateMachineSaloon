...
function ChangePathsToCDNTask() {
	...
	/*------------------------------------------------------------------
		Variables
	------------------------------------------------------------------*/
	var taskFlow = [promptForYearAndTicket, replaceCSSPaths, replaceJSPaths, replaceImagePaths, replaceMRPaths, replaceBootPaths, updateBootDefine, replaceShareViewPaths, replaceShareModelPaths, replaceBootstrapPaths, replaceCSSFontPaths, replaceCSSImgPaths, copyNewsImage];
