...
textAnchoringTask = require('textAnchoringTask'),
...
function ProcessArticle() {
	...
	function screenHtmlLoaded() {
		...
		MView.selectedOptions.push({name: "add share tools lib -- pending", id: "addShareTools"});
		MView.selectedOptions.push({name: "add chart beat lib -- pending", id: "addChartbeat"});
		...
		MView.selectedOptions.push({name: "text anchoring -- pending", id: "textAnchoring"});
	...
	function runTask() {
		...
		if (taskObj) {
			switch(taskObj.id) {
				...
				break;
				case "addShareTools":
					//init the share tools module
					addShareToolsTask.go();
				break;
				case "addChartbeat":
					//init the chart beat module
					addChartbeatTask.go();
				break;
				case "generalStyling":
