...
function CheckShortHandDirectory() {
	...
	function sanityCheckDirectoryandContents(folderPath) {
		...
		// * check that there is a js file with the string 'story' in its file name at /static/js/
		...
		if (doesIndexFileExist(folderPath + "/index.html") && doesStoryJsfileExist(folderPath + "/static/js")) {
