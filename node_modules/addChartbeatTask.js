...
function AddChartbeatTask() {
	...
	function addBodyScript() {
		var scriptStr = "<!-- Chartbeat Web Analytics code - start -->" +
						"<script type='text/javascript'>" +
							...
							"_sf_async_config.path = 'chartBeatIndexHtmlPath';" +
							"_sf_async_config.title = 'chartBeatStoryTitle';" +
							"/** CONFIGURATION END **/" +
							"(function(){" +
	...
	function promptForNameAndPath() {
		var promptMarkup = "<div class=\"userPromptHolder\">" +
								...
								"</p>" +
								"<input id='storyName' type='text' value='A good man in Rwanda' style='display:block;'/>" +
								"<p>" +
								...
								"</p>" +
								"<input id='indexHtmlPath' type='text' value='/news/special/2014/newsspec_6954/index.html' style='display:block;'/>" +
